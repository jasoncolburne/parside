...
impl GroupItem for CesrGroup {
    fn qb64(&self) -> ParsideResult<String> {
        match self {
            ...
            CesrGroup::SealSourceTriplesVariant { value } => value.qb64(),
    ...
    fn qb64b(&self) -> ParsideResult<Vec<u8>> {
        match self {
            ...
            CesrGroup::SealSourceTriplesVariant { value } => value.qb64b(),
    ...
    fn qb2(&self) -> ParsideResult<Vec<u8>> {
        match self {
            ...
            CesrGroup::SealSourceTriplesVariant { value } => value.qb2(),
    ...
    fn full_size(&self) -> ParsideResult<usize> {
        match self {
            ...
            CesrGroup::SealSourceTriplesVariant { value } => value.full_size(),
